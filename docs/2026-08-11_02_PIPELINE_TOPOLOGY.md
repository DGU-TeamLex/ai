...
알루미늄과 PP의 과거 탐색 p값은 다중검정과 독립 검증을 통과한 운영 근거가 아니다.
특히 PP 관세청 수입가→2개월 기말재고는 최신 24개월 검증에서 p=0.4617로 재현되지 않았다.
따라서 매핑 확대 여부와 별개로 외부 위험은 shadow 분석에만 두고 자동 발주를 바꾸지 않는다.
